...
func (x *GetOrderReqeust) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOrderReqeust) ProtoMessage() {}

func (x *GetOrderReqeust) ProtoReflect() protoreflect.Message {
	mi := &file_orders_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOrderReqeust.ProtoReflect.Descriptor instead.
func (*GetOrderReqeust) Descriptor() ([]byte, []int) {
	return file_orders_proto_rawDescGZIP(), []int{3}
}

func (x *GetOrderReqeust) GetCustomerID() int32 {
	if x != nil {
		return x.CustomerID
	}
	return 0
...
var file_orders_proto_rawDesc = []byte{
	...
	0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x65, 0x75, 0x73, 0x74, 0x12, 0x1e, 0x0a,
	...
	0x08, 0x2e, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_orders_proto_goTypes = []interface{}{
	...
	(*GetOrderReqeust)(nil),     // 3: GetOrderReqeust
